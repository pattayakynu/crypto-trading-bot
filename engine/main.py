...
def run_signal_pipeline(pair: str, session, services: dict, client) -> dict:
    ...
    # BTC 24h change: always use get_btc_change_pct() which tries Binance then
    # falls back to CoinGecko.  Using price_change directly for BTCUSDT was broken
    # when Binance is geo-blocked (price_change = 0 → BTC Lead always 0).
